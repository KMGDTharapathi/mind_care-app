...
class _AimDropGameState extends State<AimDropGame>
  ...
  void initState() {
    ...
    ).animate(CurvedAnimation(parent: _pendulum, curve: Curves.easeInOut));
  }
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  '${LanguageProvider.of(context).round}: $_round',
                  style: const TextStyle(
                    fontWeight: FontWeight.bold,
                    color: Color(0xFF2E7D32),
                  ),
          ...
          Expanded(
            child: AnimatedBuilder(
              ...
              builder: (context, _) {
                final size = MediaQuery.of(context).size;
                final ballX =
                    ((_swingAnim.value + 1) / 2) * (size.width - 64) + 16;
                return Stack(
                  children: [
                    // Rope
                    Positioned(
              ...
              children: List.generate(
                ...
                (i) => Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _zones[i].color.withValues(
                        alpha: i == _targetZoneIdx ? 1.0 : 0.4,
                      ),
